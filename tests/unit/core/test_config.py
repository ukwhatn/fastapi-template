...
class TestConfigDatabaseURI:
    ...
    def test_database_uri_from_database_url(self, monkeypatch):
    ...
    def test_database_uri_from_individual_settings(self):
    ...
    def test_database_uri_none_when_no_config(self):
...
class TestConfigHasDatabase:
    ...
    def test_has_database_true(self, monkeypatch):
    ...
    def test_has_database_false(self):
...
class TestConfigIsSupabase:
    ...
    def test_is_supabase_true(self, monkeypatch):
    ...
    def test_is_supabase_false(self, monkeypatch):
    ...
    def test_is_supabase_false_when_no_database(self, monkeypatch):
        """データベース設定がない場合、Falseを返すこと"""
