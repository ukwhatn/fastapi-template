...
class TestFingerprint:
    ...
    def test_fingerprint_difference_by_user_agent(self):
    ...
    def test_fingerprint_difference_by_ip(self):
    ...
    def test_verify_fingerprint_failure_wrong_user_agent(self):
    ...
    def test_verify_fingerprint_failure_wrong_ip(self):
...
class TestSessionEncryption:
    ...
    def test_encryption_with_explicit_key(self):
    ...
    def test_encryption_enabled_with_explicit_key(self):
    ...
    def test_encryption_without_key_uses_settings(self, monkeypatch):
    ...
    def test_encryption_with_invalid_key_disables_encryption(self):
    ...
    def test_encryption_with_none_key_and_no_env_disables_encryption(self, monkeypatch):
    ...
    def test_encrypt_japanese_characters(self):
        """日本語を含むデータを暗号化できること"""
        encryptor = get_session_encryption()
        data = {"name": "テストユーザー", "message": "こんにちは世界"}
        encrypted = encryptor.encrypt(data)
        decrypted = encryptor.decrypt(encrypted)
        assert decrypted == data
