...
while [ $ELAPSED -lt $MAX_WAIT ]; do
    if docker compose -f compose.prod.yml ps | grep -q "healthy"; then
...
if [ $ELAPSED -ge $MAX_WAIT ]; then
    ...
    echo "Check logs: docker compose -f compose.prod.yml logs"
    echo ""
...
echo "  - Monitor health: docker compose -f compose.prod.yml ps"
echo ""
